...
# Install RubyGems 2.4.7
wget http://production.cf.rubygems.org/rubygems/rubygems-2.4.7.tgz
tar xfz rubygems-2.4.7.tgz
cd rubygems-2.4.7
/opt/ruby/bin/ruby setup.rb
cd ..
rm -rf rubygems-2.4.7*

# Install ffmpeg for processing videos
wget https://www.ffmpeg.org/releases/ffmpeg-2.5.6.tar.bz2
tar xfj ffmpeg-2.5.6.tar.bz2
cd ffmpeg-2.5.6
cp ff* /usr/local/bin/.
cd ..
rm -rf ffmpeg-2.5.6*
...
tar xfj postgresql-9.3.3.tar.bz2
cd postgresql-9.3.3
